labpmm <- function(y, t, numUnit, obsPerUnit, numFixEff,
  ...
  # get_func_for_k <- function(k, gamma.a, gamma.b, fix.eff.var){
  #   ## Return function of posterior of eta 
  #   .cov.mat = diag(rep(c(fix.eff.var, exp(k)), times = c(numFixEff,numUnit)))
  ...
  #     gamma.b /exp(k) + (numUnit/2+gamma.a)*k -1/2* log(det(.la.var))
  #   return(funcval)
  # }
  # 
  # kMode <- optimize(get_func_for_k, c(-20, 20), tol = 0.0001, 
